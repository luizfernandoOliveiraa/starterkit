...
if __name__ == "__main__":
    ...
    load_excel(data_frame=combined_data, output_path="data/output", file_name="combined_data")
    
    print("Data processing complete. The combined data has been saved to 'data/output/combined_data.xlsx'.")
